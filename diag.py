...
if __name__ == '__main__':
   ...
   print (classify(tree, ['n','n','n','n','n','n','y','n','y','n','y','n','n'])) 
...
#The symptoms types are Harcoded in the Decision Tree and if the corresponding symptom is present then it's flag is made 'y' else 'n'
